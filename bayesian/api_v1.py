...
from .utils import (get_system_version, retrieve_worker_result, get_cve_data,
                    ...
                    get_recommendation_feedback_by_ecosystem, get_cves_info)
...
class CvesByDateEcosystem(ResourceWithSchema):
    ...
    def get(modified_date, ecosystem=None):
        ...
        result = get_cves_info(modified_date, ecosystem)
        return result, 200
...
add_resource_no_matter_slashes(CvesByDateEcosystem, '/cves/bydate/<modified_date>/<ecosystem>')
