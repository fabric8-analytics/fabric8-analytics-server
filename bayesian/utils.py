...
class CveByDateEcosystemUtils:
    ...
    select('cve').by(valueMap())).range(begin,end)\
    """
    ...
    def get_cves_by_date(self):
        ...
        bindings = {
            'modified_date': self._bydate,
            'begin': self._query_begin, 'end': self._query_begin + self._delta
        }
    ...
    def get_cves_by_date_ecosystem(self):
        ...
        bindings = {
            'modified_date': self._bydate, 'ecosystem': self._ecosystem,
            'begin': self._query_begin, 'end': self._query_begin + self._delta
        }
        return self.get_cves(script, bindings)
